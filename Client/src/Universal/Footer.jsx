...
export default function Footer() {
  return (
    ...
    <footer id="footer" className="footer-1">
          ...
          <div className="row">
            <div className="col-xs-12 col-sm-6 col-md-3">
              <div className="widget subscribe no-box">
                <h5 className="widget-title">
                 Realspace Group
                  <span />
                 <img src="C:\Users\bahad\Desktop\realspacelogo.jpg" alt="" />
                </h5>
               <div className="real-about"> <p> With a deep understanding of the market and a passion for
                   helping clients, we strive to exceed expectations in every transaction </p>
            </div>
              </div>
            </div>
            <div className="col-xs-12 col-sm-6 col-md-3">
            ...
            <div className="col-xs-12 col-sm-6 col-md-3">
              <div className="widget no-box">
                ...
                <p>Contact us for finding you dream home</p>
                <a className="btn" href="https://bit.ly/3m9avif" target="_blank">
                 Contact us form
                </a>
              </div>
            </div>
            <div className="col-xs-12 col-sm-6 col-md-3">
              <div className="widget no-box">
                ...
                <p>
                  <a className="mail-color" href="realspacegroups@gmail.com" title="glorythemes">
                  realspacegroups@gmail.com
                  </a>
                </p>
                <ul className="social-footer2">
                  ...
                  <li className="">
                    <a
                      href="https://www.facebook.com/RealSpaceGroup"
                      target="_blank"
                      title="Facebook"
                    >
                      <img
                  ...
                  <li className="">
                    <a
                      title="instagram"
                      target="_blank"
                      href="https://www.instagram.com/realspacegroups/"
                    >
                      <img
                        alt="instagram"
                        width={30}
      ...
      <div className="footer-arnav">
        {/* <div className="container">
          <div className="row"> */}
            <div className="col-md-12">
              <p>Copyright Realspace group © 2023. All rights reserved.</p>
            </div>
          </div>
        {/* </div>
      </div> */}
