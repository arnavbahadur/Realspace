    ...
    <div>
      <div className="housePreivew-page">
        ...
        <div className="housePreview-topSection">
          ...
          <img
            src="https://images.unsplash.com/photo-1480714378408-67cf0d13bc1b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=870&q=8"
            alt="house"
          />
          {/* img bypass */}
        ...
        <div className="housePreview-section-1 housePreview-section">
          <div className="housePreview-top">
            <div className="housePreview-top-left">
              <p className="housePreview-name">{content.title}</p>
          ...
          <div className="housePreview-pics">{/* pic component */}</div>
        </div>
