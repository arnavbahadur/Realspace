    ...
    <div>
      ...
      <div className="house-card-section">
        {currentContent.map(item=>{
          ...
          return <HouseBox title={item.title} id={item._id}  houseboximgUrl={item.houseboximgUrl}  gallery={item.Gallery} location={item.location} price={item.price} Purpose={item.Purpose} location_url={item.location_url} img={item.img} bedRoom={item.bedRoom} bathRoom={item.bathRoom} areaSqFt={item.areaSqFt}  />
