...
const Dropdown = ({ placeHolder }) => {
  ...
  const budget = [
    "below 40 Lakh Rs",
    "41 Lakh Rs - 60 Lakh Rs",
    "61 Lakh Rs - 80 lakh Rs",
    "81 Lakh Rs - 1 cr Rs",
    "1+cr Rs",
  ];
      ...
      <div className="dropdown-input">
        <div className="col-filter">
          <div className="row-filter">
            ...
            <p onClick={() => setOpen(!open)} className="pfilter-color">
              {Propertytype}
              <Icon />{" "}
            </p>
            {open && (
        ...
        <div className="col-filter">
          <div className="row-filter">
            ...
            <p onClick={() => setOpen1(!open1)} className="pfilter-color">
              {locationvalue} <Icon />
            </p>
        ...
        <div className="col-filter">
          <div className="row-filter">
            ...
            <p onClick={() => setOpen2(!open2)} className="pfilter-color">
              {price} <Icon />
            </p>
            {open2 && (
              <div className="dropdown-content">
