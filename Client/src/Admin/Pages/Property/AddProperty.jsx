      ...
      <div className="add-area add_event_area" id="add_event_area">
        ...
        <div>
          ...
          <input
            ...
            id=""
            className="eventtitle"
            placeholder="dateofpossesion"
            onChange={handleChange}
            name="dateofpossesion"
            value={FormData.dateofpossesion}
          />
          <input
            type="text"
            id=""
          ...
          <input
            ...
            id=""
            className="eventtitle"
            placeholder="property_url of ifram"
            onChange={handleChange}
            name="property_url"
          ...
          <input
            ...
            id=""
            className="eventtitle"
            placeholder="location_url of ifram"
            onChange={handleChange}
            name="location_url"
